...
pickle_in = open("/Users/nouhailanigrou/clustering.pkl", "rb")
clustering = joblib.load(pickle_in)

with open('/Users/nouhailanigrou/scaling_model.pkl', 'rb') as file:
    loaded_scaling_model = joblib.load(file)

with open('/Users/nouhailanigrou/pca.pkl', 'rb') as file:
    loaded_pca_model = joblib.load(file)

with open('/Users/nouhailanigrou/one_hot_encoded_df.pkl', 'rb') as file:
